...
from rest_framework_simplejwt.views import TokenRefreshView  # Add Token refresh

# Import your custom views (e.g., UpdateItemOfTheDayView, AssignDeliveryCrewView)
from .views import UpdateItemOfTheDayView, AssignDeliveryCrewView
...
urlpatterns = [
    ...
    path('item-of-the-day/update/', UpdateItemOfTheDayView.as_view(), name='update-item-of-the-day'),
